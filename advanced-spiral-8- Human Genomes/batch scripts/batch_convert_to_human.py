"""
Batch converter: Convert E. coli visualization files to Human Genome versions
Creates human genome versions of key visualization files with auto-detection
"""
...
def convert_file(input_file, output_file):
    """Convert a single file from E. coli to Human Genome"""
    ...
    if 'find_human_fasta' in content:
    ...
    content = re.sub(r'\bE\. coli\b|\bE\.coli\b', 'Human Genome', content)

    # Update background colors for better visualization
...
def main():
    ...
    print("\n" + "="*70)
    print("BATCH CONVERSION: E. coli → Human Genome Visualization Files")
    print("="*70 + "\n")
    ...
    for filename in FILES_TO_CONVERT:
        input_path = filename
        # Create human_ version
        base = filename.replace('.py', '')
        output_path = f'human_{base}.py'
    ...
    print("\n" + "="*70)
    print("Next step: Run batch_test_human.py to verify all files")
    print("="*70 + "\n")
