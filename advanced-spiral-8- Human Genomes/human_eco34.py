...
donut_vis = Markers(pos=np.zeros((2, 3)), face_color='yellow', size=6)
...
# Lattice push: simple positive/negative movement
...
def update(ev):
    ...
    # Drift and small anticorrelated noise
    ...
    # Spawn organelles based purely on genome
    ...
    # Push organelles along lattice
    lattice_nodes = np.array(accum_s1 + accum_s2)
    for org in organelles:
        positive = base in ['A','T']  # Fasta positive/negative
