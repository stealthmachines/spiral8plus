...
comp_line1 = Line(pos=np.zeros((100, 3)), color='cyan', width=2, parent=comp_view.scene)
comp_line2 = Line(pos=np.zeros((100, 3)), color='cyan', width=2, parent=comp_view.scene)
res_markers = Markers(pos=np.zeros((100, 3)), face_color='white', size=6, parent=comp_view.scene)
pct_text = Text('0%', pos=(0, 0, 10), color='white', font_size=14, parent=comp_view.scene)
