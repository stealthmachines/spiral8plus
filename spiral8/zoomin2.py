"""
FASTA Single Cell Holographic Zoom — Fixed Camera
GPU-accelerated φ-spiral chromosome
Everything is FASTA-driven, fully volumetric, high-detail single cell
Install: pip install vispy pyqt6 numpy
Run: python fasta_single_cell_fixed_camera.py
"""
...
# Fixed camera: no automatic zoom or elevation changes
