...
Everything emerges from the genome; nothing is contrived. Multi-generation supported.
Install: pip install vispy pyqt6 numpy
Run: python fasta_universe_full.py
"""
...
cells = [{"lattice": [], "organelles": [], "frame": 0, "id":0, "generation":0}]
next_cell_id = 1
