...
period = 13.057
t_max = period * 8
speed_factor = 6.0          # fast emergence for viral genome
...
# Title and info
title_text = Text("SARS-CoV-2 Wuhan-Hu-1 - Echoing φ-Spiral",
...
def update(ev):
    ...
    N = 500  # Optimized for viral genome
    ...
    # ---- emerge new rung every 18 frames (faster for viral genome) ----
...
if __name__ == '__main__':
    print("\n" + "="*70)
    print("SARS-CoV-2 Wuhan-Hu-1 Echoing φ-Spiral Visualization")
    print("="*70)
    print(f"Genome: {genome_len:,} nucleotides (single-stranded RNA)")
