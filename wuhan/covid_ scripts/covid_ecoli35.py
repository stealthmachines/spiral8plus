"""
Generative DNA φ-Harmonic Spiral — Multi-SARS-CoV-2 volumetric environment
...
NUM_BACTERIA = 3  # number of SARS-CoV-2 in environment
...
canvas = scene.SceneCanvas(keys='interactive', size=(1200,800),
                           bgcolor='#000011', title="Multi-SARS-CoV-2 Environment")
