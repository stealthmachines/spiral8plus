# dna_echo_colour_persistent_harmonic_red.py
# --------------------------------------------------------------
# GPU-accelerated double φ-spiral with fully persistent colors
# for strands, lattices, vertices, echoes, labels,
# harmonic rainbow with whites shifted to red.
# --------------------------------------------------------------
...
geometries = [
    ...
    (8, 'C', 'red',           'Octacube',     0.012345, 16),  # was white
]
