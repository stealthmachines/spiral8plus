...
strand_vis_1 = Line(pos=np.zeros((100, 3)), color='cyan', width=2)
strand_vis_2 = Line(pos=np.zeros((100, 3)), color='cyan', width=2)
donut_trail = Markers(pos=np.zeros((2, 3)), face_color='yellow', size=6, parent=comp_view.scene)
