...
strand1_vis = Line(pos=empty_pos, color=(1,1,1,0.7), width=2)
strand2_vis = Line(pos=empty_pos, color=(1,1,1,0.7), width=2)
...
link_lines = Line(pos=np.zeros((2,3),dtype=np.float32),
                  color=(1,1,0,0.4), width=1, connect='segments')
