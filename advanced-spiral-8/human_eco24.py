...
# Strands
strand1 = Line(pos=np.zeros((1, 3)), color=(1, 1, 1, 0.7), width=2, parent=comp_view.scene)
strand2 = Line(pos=np.zeros((1, 3)), color=(1, 1, 1, 0.7), width=2, parent=comp_view.scene)

# Composite strands
comp_strand1 = Line(pos=np.zeros((1, 3)), color=(1, 1, 0, 0.9), width=3, parent=comp_view.scene)
comp_strand2 = Line(pos=np.zeros((1, 3)), color=(1, 1, 0, 0.9), width=3, parent=comp_view.scene)
